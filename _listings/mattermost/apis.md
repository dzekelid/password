...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/password/master/_listings/mattermost/apis.md
...
- name: Mattermost API Reference - Reset password
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/password/master/_listings/mattermost/userspasswordreset-post-openapi.md
- name: Mattermost API Reference - Update a user's password
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/password/master/_listings/mattermost/usersuser-idpassword-put-openapi.md
- name: Mattermost API Reference - Send password reset email
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/password/master/_listings/mattermost/userspasswordresetsend-post-openapi.md
x-common:
- type: x-api-gallery
