...
created: "2018-08-28"
modified: "2018-08-28"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/password/master/_listings/aws-storage-gateway-service/apis.md
...
- name: AWS Storage Gateway Service API - Set Local Console Password
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/password/master/_listings/aws-storage-gateway-service/actionsetlocalconsolepassword-get-postman.md
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/password/master/_listings/aws-storage-gateway-service/actionsetlocalconsolepassword-get-openapi.md
x-common:
- type: x-api-gallery
